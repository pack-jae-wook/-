...
// 데이터 베이스 호스트 이름
#define FIREBASE_HOST  "hello-fb01-df75d-default-rtdb.firebaseio.com"

// 데이터 베이스 비밀번호
#define FIREBASE_AUTH "rm1gbTGhf3S9NTORhp9a8sgYxLU7kOomNa9uDrEP"

// Wi-Fi 설정
#define WIFI_SSID "AP-102-1203"
#define WIFI_PASSWORD "81933?d6"
